      ...
      {(props) => (
        <div style={props} className="section1">
          ...
          <ul data-aos={"fade-right"}>
            ...
            <li> My favorite is creating React and Angular frontend apps.</li>
            <li>
              Using PHP and jQuery to build backends for dynamic web content.
            </li>
            <li>
              Using Bootstrap, Angular Material, Material UI, Material Design,
              Bulma and AOS to build designs faster.
            </li>
